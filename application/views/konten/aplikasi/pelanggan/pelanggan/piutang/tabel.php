                    ...
                    <table id="tabel" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="header_rupiah text-center">Piutang</th>
                            </tr>
                        </thead>
...
?>
                                <tr>
                                    <td class="text-center">
                                        <a class="link_tabel" href="<?php echo site_url().'Pelanggan/Buka_PiutangPelanggan?no='.$data->No; ?>">
<?php
                                            echo $no++;
?>
                                        </a>
...
<?php
                                            echo number_format($data->Piutang, 2, ',', '.');
?>
                                        </span>
                                    </td>
                                </tr>
...
?>
                        ...
                        <tfoot>
                            <tr>
                                <th class="text-center" colspan="4">Total Piutang</th>
