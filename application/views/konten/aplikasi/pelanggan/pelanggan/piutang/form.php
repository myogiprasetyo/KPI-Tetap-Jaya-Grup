...
?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="text_piutang" class="col-sm-4">
                                        <div class="input-group">
                                            <span class="input-group-addon">Rp</span>
                                            
                                            <input type="text" class="rupiah form-control" name="piutang" <?php if ($konten != 'Tambah') { echo 'value="'.number_format($piutang, 2, ',', '.').'"'; } ?>>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
?>                        
                        <a href="<?php echo site_url(); ?>Pelanggan/PiutangPelanggan" class="btn btn-default pull-right">
