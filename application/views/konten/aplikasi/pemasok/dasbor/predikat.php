<div class="box box-primary animated fadeInDown">
    <div class="box-header ui-sortable-handle" style="cursor: move;">
        ...
        <h3 class="box-title">Predikat Pemasok</h3>
        ...
        <div class="pull-right box-tools">
            <div class="btn-group">
                ...
                <ul id="ketentuan_predikat" class="dropdown-menu pull-right" role="menu">
                    ...
                    <li><span class="label bg-yellow-active">Predikat D = Nilai 70,4 - 60,5</span></li>
...
?>
                    <a href="<?php echo base_url().'Pemasok/NilaiPemasok?predikat='.$data; ?>">
...
<?php
                                    echo number_format($persentase[$data], 1, ',', '.').'%';
?>
                                </span>

                                <div class="progress">
                                    <div class="progress-bar" style="width: <?php echo number_format($persentase[$data], 1, '.', ','); ?>%"></div>
                                </div>
                                
                                <span class="progress-description">
<?php
                                    echo $nilai[$data].' dari '.$nilai['jumlah'].' Pemasok';
?>
                                </span>
                            </div>
                        </div>
