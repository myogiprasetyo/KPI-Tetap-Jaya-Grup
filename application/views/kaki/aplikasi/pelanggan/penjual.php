...
?>
                        ...
                        if (data.no_penjual !== '') {
                            $('#no_penjual').addClass('animated tada has-error').append(data.no_penjual);
                        };

                        if (data.nama_penjual !== '') {
                            $('#nama_penjual').addClass('animated tada has-error').append(data.nama_penjual);
                        };
                    };
                }
            });
