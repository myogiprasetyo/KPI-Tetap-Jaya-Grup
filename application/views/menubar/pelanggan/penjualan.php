            ...
            <ul class="dropdown-menu" role="menu">
                <form role="form" method="post" action="<?php echo site_url().'Pelanggan/'.str_replace(' ', '', $konten); ?>">
                    <div class="box-body menubar_filter_2">
                        ...
                        <div class="form-group">
                            <label class="menubar_menu col-sm-12 control-label">Pelanggan</label>
...
?>
                                        <option value="<?php echo $data->NoPelanggan; ?>" <?php if ($pelanggan_select == $data->NoPelanggan) { echo 'selected'; } ?>>
<?php
